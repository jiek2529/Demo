...
public class MyIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "jiek.demo.action.FOO";
    private static final String ACTION_BAZ = "jiek.demo.action.BAZ";
    ...
    public void onStart(Intent intent, int startId) {
        ...
        l("onStart: " + count);
//        doSomething();
//        l("onstart thead.sleep complete! ==> "+count);
    }
    ...
    public void onDestroy() {
        ...
        startService(new Intent("jiek.demo.abc"));
    }
